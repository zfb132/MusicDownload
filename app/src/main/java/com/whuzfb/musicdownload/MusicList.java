...
public class MusicList extends AppCompatActivity implements View.OnClickListener,AbsListView.OnScrollListener{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.linear_music);
        ...
        mList = new ArrayList<MusicList.NoteListItem>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MusicList.this,"这是"+position,Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void loadData() {
        ...
        if(adapter.getCount()==TOTAL_LENGTH)
            flag_end=true;
        for (int i = count; (i < count + 5)&&(i <TOTAL_LENGTH); i++) {
    ...
    class NoteListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(MusicList.this).inflate(
                        R.layout.linear_music_listitem, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.item_add){
            ...
            Toast.makeText(MusicList.this,"点击我就会添加",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(MusicList.this,"点击我就会删除",Toast.LENGTH_SHORT).show();
        }
    ...
    private class ModeCallback implements ListView.MultiChoiceModeListener {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            if (mMultiSelectActionBarView == null) {
                mMultiSelectActionBarView = LayoutInflater.from(MusicList.this)
        ...
        public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
            if (mMultiSelectActionBarView == null) {
                ViewGroup v = (ViewGroup)LayoutInflater.from(MusicList.this)
                        .inflate(R.layout.actionbar_list_select, null);
